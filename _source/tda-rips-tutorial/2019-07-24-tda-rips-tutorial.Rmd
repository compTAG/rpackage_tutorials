...
So we have a two-simplex when $$r=\sqrt{13}$$. By hand, we also computed $$\text{VR}(S, \sqrt{13})$$ to be a two simplex! Accessing the other complex and filtration value elements verifies the rest of the filtration computation we did earlier.
