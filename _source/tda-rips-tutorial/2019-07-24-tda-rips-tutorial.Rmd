...
If we want to visualize the Rips filtration, we can run the following code.


```{r visualization_echo, echo = TRUE, message = FALSE, results='hide', eval = FALSE, fig.keep = 'none'}

S_RipsFilt <- ripsFiltration(S, maxdimension = 2, maxscale = 4.5, dist = "euclidean")
...
Lastly, we can visualize the Rips filtration. 

```{r bigfootfiltration, echo = TRUE, message = FALSE, results = 'hide'}
