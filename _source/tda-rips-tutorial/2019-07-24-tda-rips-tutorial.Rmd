...
plot(RipsFilt, thresh = sqrt(13), animate = FALSE)
...
plot(NULL, type = "n", xlim = lim[1:2], ylim = lim[3:4],
     ...
     xlab = "", ylab = "")
for (idx in seq(along = RipsFiltManhattan[["cmplx"]])) {
...
plot(BigfootSightingsMT[,1],BigfootSightingsMT[,2], xlab = "Latitude", ylab = "Longitude",
