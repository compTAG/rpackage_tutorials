...
hull of a subset of the vertices in the simplex.In particular, a *simplicial complex* is a finite
...
Hence VR$$(S, \sqrt{13})$$ with the Manhattan distance is a simplicial complex with two edges, while with the Euclidean distance is a simplicial complex with two two-simplices.
...
Furthermore, we can look at the Rips complex at a threshold of one, by adding the argument, "thresh = 1" and changing "animate = FALSE" to "animate = TRUE". 
